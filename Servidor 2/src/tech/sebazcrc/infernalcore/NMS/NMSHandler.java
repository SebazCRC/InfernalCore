...
public interface NMSHandler {
    ...
    Entity spawnCustomCreeper(org.bukkit.Location location, CreatureSpawnEvent.SpawnReason reason, boolean quantum, boolean enderQuantum);
    Entity spawnCustomGhast(org.bukkit.Location location, CreatureSpawnEvent.SpawnReason reason);
}
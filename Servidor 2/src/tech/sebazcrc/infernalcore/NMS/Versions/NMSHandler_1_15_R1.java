...
public class NMSHandler_1_15_R1 implements NMSHandler {
            ...
            if (name.toLowerCase().contains("bat") || name.toLowerCase().contains("cod") || name.toLowerCase().contains("salmon") || name.toLowerCase().contains("squid") || name.toLowerCase().contains("pufferfish") || name.toLowerCase().contains("tropicalfish")) {
                ...
                if (reason == CreatureSpawnEvent.SpawnReason.SPAWNER_EGG) {
                    ...
                    if (new Random().nextInt(499) <= 10) {
                        ...
                        nmsEntity = (net.minecraft.server.v1_15_R1.Entity) c.getConstructor(getNMSClass("EntityTypes"), getNMSClass("World")).newInstance(convertBukkitToNMS(type), nmsW);
                    }
                } else {
    ...
    public org.bukkit.entity.Entity spawnNMSWither(Location location) {
        ...
        EntityWither wither = EntityTypes.WITHER.spawnCreature(nmsW, compound, null, null,
    ...
    public org.bukkit.entity.Entity spawnHostileMob(EntityType type, Location location, CreatureSpawnEvent.SpawnReason reason) {
        ...
        net.minecraft.server.v1_15_R1.Entity nms = null;
        ...
        try {
            ...
            if (name.toLowerCase().contains("villager") || name.toLowerCase().contains("wanderingtrader")) {
                ...
                if (name.toLowerCase().contains("villager")) {
                    ...
                    nms = (net.minecraft.server.v1_15_R1.Entity) c.getConstructor(Location.class, Main.getInstance().getNmsHandler().getNMSClass("EntityTypes"), Villager.class).newInstance(location, Main.getInstance().getNmsHandler().convertBukkitToNMS(type), null);
                } else {

                    nms = (net.minecraft.server.v1_15_R1.Entity) c.getConstructor(Location.class, Main.getInstance().getNmsHandler().getNMSClass("EntityTypes"), WanderingTrader.class).newInstance(location, Main.getInstance().getNmsHandler().convertBukkitToNMS(type), null);
                }
                ...
                if (name.toLowerCase().contains("bat") || name.toLowerCase().contains("cod") || name.toLowerCase().contains("salmon") || name.toLowerCase().contains("squid") || name.toLowerCase().contains("pufferfish") || name.toLowerCase().contains("tropicalfish")) {
                    ...
                    if (new Random().nextInt(499) <= 10) {
                        ...
                        nms = (net.minecraft.server.v1_15_R1.Entity) c.getConstructor(Location.class, Main.getInstance().getNmsHandler().getNMSClass("EntityTypes")).newInstance(location, Main.getInstance().getNmsHandler().convertBukkitToNMS(type));
                    }
                } else {
    ...
    public org.bukkit.entity.Entity spawnNMSCustomEntity(String name, EntityType type, Location location, CreatureSpawnEvent.SpawnReason reason) {
        ...
        try {
            ...
            Class c = Class.forName("tech.sebazcrc.infernalcore.CustomMobs.v1_15_R1." + name);
    ...
    @Override
    public org.bukkit.entity.Entity spawnCustomCreeper(Location location, CreatureSpawnEvent.SpawnReason reason, boolean quantum, boolean enderQuantum) {

        /**
        World nmsW = ((CraftWorld) location.getWorld()).getHandle();
        CustomCreeper nmsEntity = new CustomCreeper(EntityTypes.CREEPER, nmsW, quantum, enderQuantum);
    ...
    @Override
    public org.bukkit.entity.Entity spawnCustomGhast(Location location, CreatureSpawnEvent.SpawnReason reason) {

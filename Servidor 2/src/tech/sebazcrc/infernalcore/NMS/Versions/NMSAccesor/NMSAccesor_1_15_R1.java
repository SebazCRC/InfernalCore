package tech.sebazcrc.infernalcore.NMS.Versions.NMSAccesor;
...
public class NMSAccesor_1_15_R1 implements tech.sebazcrc.infernalcore.NMS.NMSAccesor {
    ...
    public void registerHostileMobs() {
        ...
        try {
            ...
            final Field fieldB = AttributeMapBase.class.getDeclaredField("b");
            fieldMap.setAccessible(true);

            Map<String, AttributeInstance> b = (Map<String, AttributeInstance>) fieldB.get(map);

            map.b(GenericAttributes.ATTACK_DAMAGE);

            if (!b.containsKey(GenericAttributes.ATTACK_DAMAGE.getName())) {

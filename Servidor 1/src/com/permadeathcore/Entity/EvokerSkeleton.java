...
public class EvokerSkeleton extends EntitySkeleton {

    public EvokerSkeleton(Location loc) {
        ...
        if (getBukkitEntity() instanceof LivingEntity) {
            ...
            liv.setCustomName(Main.format("&6Evoker Skeleton"));
        }

        this.goalSelector.a(0, new PathfinderGoalFloat(this));
        this.goalSelector.a(1, new PathfinderGoalAvoidTarget(this, EntityHuman.class, 8.0F, 0.6D, 1.0D));

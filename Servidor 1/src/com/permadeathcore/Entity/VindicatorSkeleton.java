...
public class VindicatorSkeleton extends EntitySkeleton {

    public VindicatorSkeleton(Location loc) {
        ...
        this.getAttributeInstance(GenericAttributes.MAX_HEALTH).setValue(32);
        ...
        if (getBukkitEntity() instanceof LivingEntity) {
            ...
            liv.setCustomName(Main.format("&6Vindicator Skeleton"));
        }
